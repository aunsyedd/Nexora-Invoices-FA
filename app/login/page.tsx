...
<br />
  <div className="flex items-center gap-2.5">
    ...
    <span className="text-[11px] font-medium tracking-[0.16em] text-white/70 uppercase">
      Nexora Invoices
    </span>
  </div>
</div>
        ...
        <div className="relative z-10">
          <h2
            className="text-[42px] font-light text-white leading-[1.15] tracking-tight mb-4"
        ...
        <div className="relative z-10 flex flex-col gap-3">
          {FEATURES.map((f) => (
            <div key={f} className="flex items-center gap-2.5">
              ...
              <span className="text-[12px] text-white/70 tracking-wide">{f}</span>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="flex flex-col justify-center items-center flex-1 min-h-screen bg-white px-8 sm:px-14 py-12">
        ...
        <div className="w-full max-w-[360px]">
          ...
          {/* Heading */}
          <div className="mb-8">
            <p className="text-[11px] font-medium tracking-[0.12em] text-gray-400 uppercase mb-2 leading-snug">
              Faisal Abdullah Muhammed Ramadan Est.
            </p>
            <h1
              className="text-[30px] font-medium text-gray-900 leading-snug"
              style={{ fontFamily: "Georgia, 'Times New Roman', serif" }}
            >
              Welcome back
            </h1>
          ...
          {/* Error */}
          {error && (
            <div className="mb-5 text-[12px] text-red-700 bg-red-50 border border-red-200 rounded-md px-4 py-2.5 leading-relaxed">
              {error}
            </div>
          )}
          ...
          <div className="text-center">
            <div className="inline-flex items-center gap-1.5 bg-gray-50 border border-gray-100 rounded-full px-3 py-1 text-[11px] text-gray-400 tracking-wide mb-4">
