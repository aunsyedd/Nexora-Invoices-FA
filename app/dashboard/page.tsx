  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-gray-100">
      ...
      <main className="flex-1 pt-14 overflow-y-auto w-full">
        <div className="w-full px-4 py-4 sm:px-6 sm:py-6 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {cards.map((card, idx) => (
              <div
                key={idx}
                className={`${card.color} text-white rounded-lg shadow-md overflow-hidden flex flex-col transition-transform hover:scale-[1.02]`}
              >
                ...
                <button
                  ...
                  className="bg-black/10 hover:bg-black/20 py-2 sm:py-2.5 text-xs sm:text-sm transition-colors text-center w-full mt-auto"
                >
                  View Details →
                </button>
              </div>
